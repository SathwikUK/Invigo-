...
import Glasses from "../../img/float1-removebg-preview.png";
  ...
  return (
    ...
    <div className="services" id="services">
      ...
      <div className="awesome-se">
        ...
        <spane>
        Invigilation module services offer simple and effective
          <br />
      ...
      <div className="cards">
        ...
        >
          <Card
            ...
            heading={"UI/UX"}
            detail={
              "In the realm of UI/UX services, we excel at creating compelling and user-friendly digital experiences."
            }
